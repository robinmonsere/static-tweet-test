<script>import { formatNumber } from "../utils.js";
export let tweet;
$:
  replyText = tweet.conversation_count === 0 ? "Read more on Twitter" : tweet.conversation_count === 1 ? `Read ${formatNumber(tweet.conversation_count)} reply` : `Read ${formatNumber(tweet.conversation_count)} replies`;
</script>
